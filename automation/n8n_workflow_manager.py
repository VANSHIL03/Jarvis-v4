...
class N8nWorkflowManager:
    ...
    def __init__(
        ...
        self.builtin_service_map: Dict[str, Dict[str, Any]] = {
            ...
            "instagram": {"tags": ["instagram", "insta", "instagram post", "post on instagram"], "webhook": "instagram-post", "service": "Instagram"},
            "youtube": {"tags": ["youtube", "youtube upload", "upload to youtube", "youtube video"], "webhook": "youtube-upload", "service": "YouTube"},
            "reddit": {"tags": ["reddit", "reddit post", "post on reddit"], "webhook": "reddit-post", "service": "Reddit"},
            "excel": {"tags": ["excel", "excel sheet", "office excel", "xlsx", "spreadsheet"], "webhook": "excel-manage", "service": "Excel"},
            "powerpoint": {"tags": ["powerpoint", "ppt", "presentation", "slides"], "webhook": "powerpoint-create", "service": "PowerPoint"},
            ...
            "google_sheets": {"tags": ["sheets", "google sheets"], "webhook": "sheets-append", "service": "Google Sheets"},
            "calendar": {"tags": ["calendar", "google calendar", "schedule", "event"], "webhook": "calendar-create", "service": "Google Calendar"},
